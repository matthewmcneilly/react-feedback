#README
Documentation - The project under the hood documentation w/ examples.


src/actions/index - Redux Action creators
src/actions/types - Variables used in action creators, lessons the possiblity of typos
src/reducers - Redux reducers


src/app - Main root screen, contains firebase init, redux store creation and inital screen
src/index Main root screen, contains the navigation bar and the application routing

src/components/common - Reusable components for any project
src/components/screens - Various project screens, app
src/images - Images used in application
src/components/Card - Card template used to represent each of a users projects
src/components/CardAddNew - Card template to click on to create a new project  


# React Project README Example
